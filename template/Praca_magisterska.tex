...
{{\bf Informatyka (Kierunek studiów)} \\ \small Informatyka taka i owaka (Główna specjalność studenta)\par}
\end{center}%

\vspace{1.5cm plus 1fill}
\begin{flushleft}
{\center {\bf \Large Imiona i nazwisko} \\ \normalsize Nr albumu: \bf 666666\par}
\end{flushleft}
\vspace{1.5cm plus 1mm minus 2mm}

\begin{center}
{\huge\textbf{Tytuł twojej pracy}\par}
\vspace{0.5cm plus 1mm minus 2mm}
...
{\large 2015 (Rok oddania pracy)\par}
\end{center}
\end{titlepage}
...
\par
\vspace{1.5cm plus 1.5fill}
Ja, niżej podpisany IMIONA NAZWISKO student Wydziału Matematyki i~Informatyki Uniwersytetu im. Adama Mickiewicza w Poznaniu oświadczam, że przedkładaną pracę dyplomową pt: ``TYTUŁ MOJEJ PRACY'' napisałem samodzielnie. Oznacza to, że przy pisaniu pracy, poza niezbędnymi konsultacjami, nie korzystałem z pomocy innych osób, a~w~szczególności nie zlecałem opracowania rozprawy lub jej części innym osobom, ani nie odpisywałem tej rozprawy lub jej części od innych osób.\\
