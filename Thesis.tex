...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{img/build_flow.png}
...
posłużyć by zabezpieczyć nasz kod źródłowy. W projekcie został wykorzystany sposób przez zaszyfrowanie kodu skompilowanego kodu i w trakcie działania odszyfrowanie go. Dzięki takiemu rozwiązaniu w naszym 
