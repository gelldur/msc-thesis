...
Całą ideą języka Java jest \say{Zbuduj raz, działaj wszędzie} (ang. \say{"Write once, run anywhere"})(WORA)\cite{WORA}. W przypadku Androida jednak mamy do czynienia ze specjalnym bajt kodem. Wynika to z pewnej specyfiki urządzeń mobilnych i ograniczeń praw patentowych. W rozdziale \todo{\ref{pierwszym}} został opisany proces kompilacji aplikacji.
%
\section{SMALI}
\label{smali}
%
...
%
\begin{lstlisting}[language=smali, caption={Przykład składni dyrektyw}]
...
\begin{lstlisting}[language=smali, caption={Przykład etykiet}]
:foo
...
%
Etykieta składa się z dwukropka i nazwy po nim.
\begin{lstlisting}[language=smali, caption={Przykład komentarzy}]
# virtual methods
...
\end{lstlisting}
\begin{lstlisting}[language=smali,caption={Smali}]
...
Dla przykładu:
%
\begin{lstlisting}[language=smali,caption={}]
